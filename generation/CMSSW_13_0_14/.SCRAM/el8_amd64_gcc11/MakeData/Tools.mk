...
abseil-cpp_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/abseil-cpp/20210324.2-7396c04f0a190616eb29089db537313d/include
...
ALL_TOOLS      += alpaka
alpaka_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/alpaka/develop-20230621-0e0add1a69915f1c9fab0fe26623c322/include
alpaka_EX_USE := boost
...
ALL_TOOLS      += blackhat
blackhat_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/blackhat/0.9.9-3cb5aed13335e6c23c373de04f172405/include
...
boost_header_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/boost/1.80.0-bff81045eb6d0806da34e08d781c05db/include
...
ALL_TOOLS      += bz2lib
bz2lib_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/bz2lib/1.0.6-2c1f18484cb66c30aba7929f2be5e7d4/include
bz2lib_EX_LIB := bz2
bz2lib_EX_USE := root_cxxdefaults

ALL_TOOLS      += c-ares
c-ares_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/c-ares/1.15.0-240b8214961b58570acaa99c86e8da7d/include
c-ares_EX_LIB := cares

ALL_TOOLS      += catch2
catch2_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/catch2/2.13.6-84fde6927c396f2973a03635196e7a49/include

ALL_TOOLS      += cepgen
cepgen_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/cepgen/1.0.2patch1-84811c01aaaae54ba12949206213bd86/include
...
ALL_TOOLS      += classlib
classlib_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/classlib/3.1.3-52a2fe4d34a5f733d734f75ee05cb886/include
...
coral_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/cms/coral/CORAL_2_3_21-0c6298d2d88b04357d1548a007ebd73c/include/LCG
coral_EX_USE := root_cxxdefaults
coral_ORDER := 98000

ALL_TOOLS      += correctionlib
correctionlib_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/py3-correctionlib/2.1.0-6eee070cdfb1c2069b2eeef24747c809/lib/python3.9/site-packages/correctionlib/include
correctionlib_EX_LIB := correctionlib

ALL_TOOLS      += cppunit
cppunit_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/cppunit/1.15.x-c4570d64b509e2e0614dc83d98c1df8c/include
cppunit_EX_LIB := cppunit
cppunit_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += cpu_features
cpu_features_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/cpu_features/0.7.0-d3b13cbc2a9c6f5528dcc3226634c43d/include
cpu_features_EX_LIB := cpu_features

ALL_TOOLS      += csctrackfinderemulation
csctrackfinderemulation_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/cms/CSCTrackFinderEmulation/1.2-f743171ba99b52f2b8933c74be392a12/include
...
cuda-stubs_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/cuda/11.5.2-66a9473808e7d5863d5bbec0824e2c4a/include
cuda-stubs_EX_LIB := cuda
cuda-stubs_EX_LIBDIR := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/cuda/11.5.2-66a9473808e7d5863d5bbec0824e2c4a/lib64/stubs
cuda-stubs_EX_FLAGS_SKIP_TOOL_SYMLINKS  := 1

ALL_TOOLS      += cuda
ALL_LIB_TYPES += CUDA_LIB
cuda_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/cuda/11.5.2-66a9473808e7d5863d5bbec0824e2c4a/include
...
ALL_TOOLS      += cudnn
cudnn_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/cudnn/8.3.3.40-f695d8da25ea237d13163efe80685c22/include
cudnn_EX_LIB := cudnn
cudnn_EX_USE := cuda

ALL_TOOLS      += cupti
cupti_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/cuda/11.5.2-66a9473808e7d5863d5bbec0824e2c4a/include
cupti_EX_LIB := cupti

ALL_TOOLS      += curl
curl_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/curl/7.79.0-5e48e0bf013ba13376a33ec8da72dabc/include
curl_EX_LIB := curl
curl_EX_USE := root_cxxdefaults

ALL_TOOLS      += dablooms
dablooms_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/dablooms/0.9.1-dfdd93a51a36797f9aeb5dfcea5af9ab/include
dablooms_EX_LIB := dablooms

ALL_TOOLS      += das_client

ALL_TOOLS      += davix
davix_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/davix/0.8.1-6a3ab76b8d48f6d7bfc1565085a90fa3/include/davix
davix_EX_LIB := davix
davix_EX_USE := boost_system libxml2

ALL_TOOLS      += db6
db6_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/db6/6.2.32-16f729842d558005f3c577e0de97893d/include
db6_EX_LIB := db

ALL_TOOLS      += dcap
dcap_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/dcap/2.47.12-ef79ca4ec7d517ad93018edfef3356c2/include
dcap_EX_LIB := dcap
...
dip_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/dip/8693f00cc422b4a15858fcd84249acaeb07b6316-6e9ddbd094212a923b04caa63eb9c45c/include

ALL_TOOLS      += eigen
eigen_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/eigen/82dd3710dac619448f50331c1d6a35da673f764a-b0dc243d10365424e66e60c822ab818e/include/eigen3
eigen_EX_FLAGS_CPPDEFINES  := -DEIGEN_DONT_PARALLELIZE
eigen_EX_FLAGS_CUDA_FLAGS  := --diag-suppress 20014

ALL_TOOLS      += evtgen
evtgen_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/evtgen/2.0.0-38f8f169c002879b4c764a05bff24769/include
evtgen_EX_LIB := EvtGen EvtGenExternal
evtgen_EX_USE := hepmc pythia8 tauolapp photospp

ALL_TOOLS      += expat
expat_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/expat/2.1.0-5f6457b4c04e97afec6079bd7d2db998/include
expat_EX_LIB := expat
expat_EX_USE := root_cxxdefaults

ALL_TOOLS      += fastjet-contrib-archive
fastjet-contrib-archive_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/fastjet-contrib/1.044-68eeaf77c418a157c1532223764bc954/include
...
fastjet-contrib_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/fastjet-contrib/1.044-68eeaf77c418a157c1532223764bc954/include
fastjet-contrib_EX_LIB := fastjetcontribfragile

ALL_TOOLS      += fastjet
fastjet_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/fastjet/3.4.0-a31b3d7621aa3e26e075c913ff770207/include
fastjet_EX_LIB := fastjetplugins fastjettools siscone siscone_spherical fastjet
fastjet_EX_USE := root_cxxdefaults

ALL_TOOLS      += fftjet
fftjet_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/fftjet/1.5.0-1cd7b7c71b42be65b840b68281156a1e/include
fftjet_EX_LIB := fftjet
fftjet_EX_USE := root_cxxdefaults

ALL_TOOLS      += fftw3
fftw3_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/fftw3/3.3.8-5f403c3dc6c4147769a1f10565ec7e26/include
fftw3_EX_LIB := fftw3
fftw3_EX_USE := root_cxxdefaults

ALL_TOOLS      += flatbuffers
flatbuffers_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/flatbuffers/1.12.0-0bf74850000dc3eeaa61708b095331f7/include
flatbuffers_EX_LIB := flatbuffers

ALL_TOOLS      += fmt
fmt_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/fmt/8.0.1-557ae4739f3cbc76e428d57162bae99b/include
fmt_EX_LIB := fmt

ALL_TOOLS      += freetype
freetype_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/freetype/2.10.0-7c6fc6af284a6e94f5e435c9ea3767b9/include
freetype_EX_LIB := freetype-cms
freetype_EX_USE := root_cxxdefaults

ALL_TOOLS      += frontier_client
frontier_client_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/frontier_client/2.9.1-ee993126dcdd1f2f1cc5df6ef8035e5f/include
frontier_client_EX_LIB := frontier_client
frontier_client_EX_USE := root_cxxdefaults zlib expat

ALL_TOOLS      += g4hepem_interface
g4hepem_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/g4hepem/20221014-816ab0207492214a14ba7790fec2f33a/include/G4HepEm
...
ALL_TOOLS      += gbl
gbl_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/gbl/V02-04-01-3f9aafa73114309255fadfa1e4e8071f/include
gbl_EX_LIB := GBL
gbl_EX_USE := eigen
...
gcc-plugin_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/gcc/11.2.1-f9b9dfdd886f71cd63f5538223d8f161/bin/../lib/gcc/x86_64-redhat-linux-gnu/11.2.1/plugin/include
gcc-plugin_EX_LIB := cc1plugin cp1plugin

ALL_TOOLS      += gdb

ALL_TOOLS      += gdbm
gdbm_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/gdbm/1.10-94fd72446cd6c73834b291fb1d1c6f46/include
gdbm_EX_LIB := gdbm
gdbm_EX_USE := root_cxxdefaults

ALL_TOOLS      += gdrcopy
gdrcopy_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/gdrcopy/2.3-8e85a731eebdee86e014e8a3cbe49a75/include
...
geant4_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/geant4/10.7.2-0a5e38613906bb5debc9753e0e1d40b3/include/Geant4 /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/geant4/10.7.2-0a5e38613906bb5debc9753e0e1d40b3/include
...
ALL_TOOLS      += giflib
giflib_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/giflib/5.2.0-e928fbc1a732191ff28d8dfbf2e6ee63/include
giflib_EX_LIB := gif
...
ALL_TOOLS      += gmp
gmp_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/gmp-static/6.2.1-31832e3e40269875826d89910345197e/include
gmp_EX_LIB := gmp
gmp_EX_USE := mpfr
...
google-benchmark_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/google-benchmark/1.4.x-711bd4c839cde2b5741f8929dffda4c4/include
...
gosamcontrib_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/gosamcontrib/2.0-20150803-001c255025c150fdbe081040c1f49536/include
...
ALL_TOOLS      += grpc
grpc_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/grpc/1.35.0-9c0e67d89ab1b488646303adc99d5fcc/include
...
ALL_TOOLS      += gsl
gsl_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/gsl/2.6-fcf47bcbedd800ca8386c7e2920fa474/include
gsl_EX_LIB := gsl
gsl_EX_USE := openblas root_cxxdefaults

ALL_TOOLS      += hdf5
hdf5_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/hdf5/1.10.6-790b5951e3dc26c669f2b05261863aa1/include
hdf5_EX_LIB := hdf5 hdf5_hl
hdf5_EX_USE := openmpi

ALL_TOOLS      += hector
hector_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/hector/1.3.4_patch1-938487bfcffe2e713aa23525cb0ac1fe/include
...
ALL_TOOLS      += hepmc3
hepmc3_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/hepmc3/3.2.5-401f2affed4e1d784818a1035e8f9f9a/include
hepmc3_EX_LIB := HepMC3 HepMC3search

ALL_TOOLS      += hepmc_headers
hepmc_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/hepmc/2.06.10-892134cadaa17164a15ce108f11ec15f/include
hepmc_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += heppdt
heppdt_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/heppdt/3.04.01-1bbda45c67d229c2b2e8a19462c4c3c9/include
heppdt_EX_LIB := HepPDT HepPID
heppdt_EX_USE := root_cxxdefaults

ALL_TOOLS      += herwig7
herwig7_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/herwig7/7.2.2-a4becc9f445057687eeb14500cd741c8/include
herwig7_EX_LIB := HerwigAPI
herwig7_EX_USE := root_cxxdefaults lhapdf thepeg madgraph5amcatnlo openloops

ALL_TOOLS      += highfive
highfive_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/highfive/2.3.1-7f6cb0002d1362228aad3a565ade3fe1/include
...
ALL_TOOLS      += hls
hls_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/hls/2019.08-fd724004387c2a6770dc3517446d30d9/include
hls_EX_USE := root_cxxdefaults
hls_EX_FLAGS_SYSTEM_INCLUDE  := 1

ALL_TOOLS      += hwloc
hwloc_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/hwloc/2.9.0-bef9c5456e9c1a1b3d71bcf07889b1b4/include/hwloc
hwloc_EX_LIB := hwloc
...
ALL_TOOLS      += hydjet2
hydjet2_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/hydjet2/2.4.3-c74468031010d7c75a15b4af9f5f1cea/include
...
ALL_TOOLS      += ittnotify
ittnotify_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/ittnotify/16.06.18-1a2fe4bfd5b3b60634b5c4cb3a739547/include
...
ALL_TOOLS      += jemalloc
jemalloc_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/jemalloc/5.3.0-0416c43bb3ec49c63e8dd3f7c38684a8/include
...
ALL_TOOLS      += ktjet
ktjet_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/ktjet/1.06-738ae10b9bb784a037c4eecb20593099/include
...
ALL_TOOLS      += lhapdf
lhapdf_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/lhapdf/6.4.0-e019996650b819a0fc60be6587a245af/include
lhapdf_EX_LIB := LHAPDF
lhapdf_EX_USE := pythia6 root_cxxdefaults

ALL_TOOLS      += libffi
libffi_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/libffi/3.4.2-748f2aaa097b8c8addf5d86f14ac1fe6/include
libffi_EX_LIB := ffi
...
libjpeg-turbo_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/libjpeg-turbo/2.0.2-217828589b5d70f70e96c4d718c063d7/include
libjpeg-turbo_EX_LIB := jpeg turbojpeg
libjpeg-turbo_EX_USE := root_cxxdefaults

ALL_TOOLS      += libpciaccess
libpciaccess_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/libpciaccess/0.16-fc432cccc1b11c5f4a0dd5b38057ed45/include
libpciaccess_EX_LIB := libpciaccess

ALL_TOOLS      += libpng
libpng_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/libpng/1.6.37-a2ff0f76300cbef7e51b77d816ff554a/include
libpng_EX_LIB := png
...
ALL_TOOLS      += libtiff
libtiff_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/libtiff/4.0.10-379c6010fabb72a8b7d2ebca2df35c1d/include
libtiff_EX_LIB := tiff
libtiff_EX_USE := root_cxxdefaults libjpeg-turbo zlib

ALL_TOOLS      += libungif
libungif_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/libungif/4.1.4-6b4f3e28660c3a9d4e75854eb8da0012/include
libungif_EX_LIB := ungif
libungif_EX_USE := root_cxxdefaults zlib

ALL_TOOLS      += libunwind
libunwind_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/libunwind/1.6.2-master-5661dca2c54f6802e98cc3676ea0f0d6/include
libunwind_EX_LIB := unwind
libunwind_EX_USE := root_cxxdefaults

ALL_TOOLS      += libuuid
libuuid_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/libuuid/2.34-0451b31e1b9a58c6aeefab41c18eea34/include
libuuid_EX_LIB := uuid
libuuid_EX_USE := root_cxxdefaults sockets

ALL_TOOLS      += libxml2
libxml2_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/libxml2/2.9.10-0a5b015a5590b04cf3087955ff42a243/include/libxml2
libxml2_EX_LIB := xml2
libxml2_EX_USE := root_cxxdefaults

ALL_TOOLS      += libxslt
libxslt_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/libxslt/1.1.28-a4d2955b124de2e8edce7aa8010617f5/include/libxslt
libxslt_EX_LIB := xslt

ALL_TOOLS      += libzmq
libzmq_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/libzmq/4.3.4-d6cc1ae2573da747d9da35021da99201/include
libzmq_EX_LIB := zmq
...
ALL_TOOLS      += llvm
llvm_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/llvm/12.0.1-476112d9475f69ecba350f77e3ec4975/include
llvm_EX_LIB := clang
...
ALL_TOOLS      += log4cplus
log4cplus_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/log4cplus/2.0.7-e5aadae24a39b3e6866151e5fb60950b/include
log4cplus_EX_LIB := log4cplusS

ALL_TOOLS      += lwtnn
lwtnn_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/lwtnn/2.13-6443dcd675cb29f0fc3ce5fa527a3b7f/include
lwtnn_EX_LIB := lwtnn
lwtnn_EX_USE := root_cxxdefaults eigen boost_system

ALL_TOOLS      += lz4
lz4_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/lz4/1.9.2-031da253be076d002e4d6af36bc64212/include
lz4_EX_LIB := lz4
...
ALL_TOOLS      += mctester
mctester_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/mctester/1.25.1-43adc37fd0a3365bc6f991c90b74d7fb/include
mctester_EX_LIB := HEPEvent HepMCEvent MCTester
mctester_EX_USE := root_cxxdefaults root hepmc

ALL_TOOLS      += md5
md5_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/md5/1.0.0-e68283f2de2e2e709a0db99db3b53205/include
md5_EX_LIB := cms-md5

ALL_TOOLS      += meschach
meschach_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/meschach/1.2.pCMS1-a6c940d49300e01334c28ef7c2460c02/include
...
ALL_TOOLS      += mpfr
mpfr_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/mpfr-static/4.1.0-1a582c613f9a8c11e13befcccb95037e/include
mpfr_EX_LIB := mpfr

ALL_TOOLS      += mxnet-predict
mxnet-predict_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/mxnet-predict/1.6.0-7ad9662f081f9188cc6124013077b785/include
mxnet-predict_EX_LIB := mxnet
mxnet-predict_EX_USE := openblas
mxnet-predict_EX_FLAGS_SYSTEM_INCLUDE  := 1

ALL_TOOLS      += numactl
numactl_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/numactl/2.0.14-0dc932de0ebe0a9cf30ae8ef9c0bbd86/include
numactl_EX_LIB := numa

ALL_TOOLS      += numpy-c-api
numpy-c-api_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/py3-numpy/1.22.4-aec0a210f14617f175dad913e0d72013/c-api/core/include
numpy-c-api_EX_LIB := npymath
numpy-c-api_EX_USE := root_cxxdefaults

ALL_TOOLS      += nvperf
nvperf_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/cuda/11.5.2-66a9473808e7d5863d5bbec0824e2c4a/include
...
onnxruntime_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/onnxruntime/1.10.0-c16b8c8056b83fa80349e9ace1475e02/include
onnxruntime_EX_LIB := onnxruntime
onnxruntime_EX_USE := protobuf cuda cudnn re2

ALL_TOOLS      += openblas
openblas_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/OpenBLAS/0.3.15-26c67b8b638762cfd2e2bcfc936e3ec7/include
openblas_EX_LIB := openblas

ALL_TOOLS      += opencv
opencv_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/opencv/4.5.5-fdbfe5ac2bc062e7c614726fa3ea2c29/include
...
ALL_TOOLS      += openmpi
openmpi_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/openmpi/4.1.5-419234dadadb982700aadb284535cc26/include
...
ALL_TOOLS      += oracle
oracle_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/oracle/19.11.0.0.0dbru-092ba337a70a02c4734616a84f842897/include
...
ALL_TOOLS      += pacparser
pacparser_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/pacparser/1.4.0-cbf4a008ddde4856a4762d7e9b1d7846/include
pacparser_EX_LIB := pacparser
pacparser_EX_USE := root_cxxdefaults

ALL_TOOLS      += pcre
pcre_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/pcre/8.43-5dcc901acc02f624b22dd9840b2357e8/include
pcre_EX_LIB := pcre
pcre_EX_USE := root_cxxdefaults zlib bz2lib

ALL_TOOLS      += pcre2
pcre2_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/pcre2/10.36-88c59c64ebe54b36ea4626d5827d6026/include
pcre2_EX_LIB := pcre2
pcre2_EX_USE := root_cxxdefaults zlib bz2lib

ALL_TOOLS      += photospp
photospp_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/photospp/3.64-1a15c8936ab06d0e1590e388d410678d/include
...
ALL_TOOLS      += protobuf
protobuf_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/protobuf/3.15.1-036bf7223636330571398e8740492e00/include
...
py3-pybind11_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/py3-pybind11/2.10.0-d3d84ce7d2c004dbd91475626499c1a1/lib/python3.9/site-packages/pybind11/include
...
pythia6_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/pythia6/426-154c9fa9309a9a96c7e05f80622d33eb/include
pythia6_headers_EX_USE := root_cxxdefaults

ALL_TOOLS      += pythia8
pythia8_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/pythia8/306-9b96ff06bd00a115810ff75b3e3eb065/include
...
ALL_TOOLS      += python3
python3_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/python3/3.9.14-76a14295dd5255228210eb596893b98c/include/python3.9
...
ALL_TOOLS      += qd
qd_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/qd/2.3.13-3e887020a27b6bda66261a2b30e928f2/include
qd_EX_LIB := qdmod qd
...
ALL_TOOLS      += rdma-core
rdma-core_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/rdma-core/39.1-7ffd1c7dfa366e47c5ab68e4bc8bc1f1/include

ALL_TOOLS      += re2
re2_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/re2/2021-06-01-6d4a75ecd01113b1930c8560c91f2106/include
re2_EX_LIB := re2

ALL_TOOLS      += rivet
rivet_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/rivet/3.1.7-e8f0856ea545f46143f13c14e4ab19b5/include
rivet_EX_LIB := Rivet
rivet_EX_USE := hepmc fastjet fastjet-contrib gsl yoda

ALL_TOOLS      += rocm-rocrand
rocm-rocrand_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/rocm-rocrand/5.4.3-e3475a4b3c5a437af6279c98f00344a9/include
rocm-rocrand_EX_LIB := hiprand rocrand
rocm-rocrand_EX_USE := rocm
rocm-rocrand_EX_FLAGS_SYSTEM_INCLUDE  := 1

ALL_TOOLS      += rocm
rocm_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/rocm/5.4.3-54a49cd5963d1f81136e5ec29a9fc8d7/include
...
root_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/lcg/root/6.26.11-fec5b250e1cd56b91a094709de26e5b8/include
...
scitokens-cpp_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/scitokens-cpp/0.7.0-e66e65b01d1e4e94ac899834ad9ef89f/include
scitokens-cpp_EX_LIB := SciTokens
scitokens-cpp_EX_USE := sqlite libuuid curl

ALL_TOOLS      += self
self_EX_INCLUDE := /uscms/homes/b/bozek/EFT_workshop24_v2/cmseft/generation/CMSSW_13_0_14/src /uscms/homes/b/bozek/EFT_workshop24_v2/cmseft/generation/CMSSW_13_0_14/include/el8_amd64_gcc11/src /uscms/homes/b/bozek/EFT_workshop24_v2/cmseft/generation/CMSSW_13_0_14/include/LCG /cvmfs/cms.cern.ch/el8_amd64_gcc11/cms/cmssw/CMSSW_13_0_14/src
self_EX_LIBDIR := /uscms/homes/b/bozek/EFT_workshop24_v2/cmseft/generation/CMSSW_13_0_14/biglib/el8_amd64_gcc11 /uscms/homes/b/bozek/EFT_workshop24_v2/cmseft/generation/CMSSW_13_0_14/lib/el8_amd64_gcc11 /uscms/homes/b/bozek/EFT_workshop24_v2/cmseft/generation/CMSSW_13_0_14/external/el8_amd64_gcc11/lib /cvmfs/cms.cern.ch/el8_amd64_gcc11/cms/cmssw/CMSSW_13_0_14/biglib/el8_amd64_gcc11 /cvmfs/cms.cern.ch/el8_amd64_gcc11/cms/cmssw/CMSSW_13_0_14/lib/el8_amd64_gcc11 /cvmfs/cms.cern.ch/el8_amd64_gcc11/cms/cmssw/CMSSW_13_0_14/external/el8_amd64_gcc11/lib
...
ALL_TOOLS      += sherpa
sherpa_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/sherpa/2.2.15-0254373d5a46d6f9e9c2ae715bb1c233/include/SHERPA-MC
...
ALL_TOOLS      += sigcpp
sigcpp_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/sigcpp/3.2.0-50e87bb1933c52adc9bdc81af5f96b5c/include/sigc++-3.0
...
ALL_TOOLS      += sqlite
sqlite_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/sqlite/3.36.0-0f26675926fd468efdd431be2b62785e/include
sqlite_EX_LIB := sqlite3
sqlite_EX_USE := root_cxxdefaults

ALL_TOOLS      += starlight
starlight_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/starlight/r193-32562079cd983e33c0d7cea2e4ef8e3c/include
...
ALL_TOOLS      += tauolapp
tauolapp_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/tauolapp/1.1.8-8bed7a73d01a87195a23e880da7bccbf/include
...
ALL_TOOLS      += tbb
tbb_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/tbb/v2021.8.0-bb5e0283c68ca6d69bd8419f6c08f7b1/include
tbb_EX_LIB := tbb
...
ALL_TOOLS      += tbbbind
tbbbind_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/tbb/v2021.8.0-bb5e0283c68ca6d69bd8419f6c08f7b1/include
...
tensorflow_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/tensorflow/2.6.4-6d7fef5740c71df02e2cdb08edbb8c31/include
tensorflow_EX_FLAGS_SYSTEM_INCLUDE  := 1

ALL_TOOLS      += thepeg
thepeg_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/thepeg/2.2.2-b4cb5de7c5f09f8b21141a1249bceae4/include
thepeg_EX_LIB := ThePEG LesHouches
thepeg_EX_USE := root_cxxdefaults lhapdf gsl

ALL_TOOLS      += tinyxml2
tinyxml2_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/tinyxml2/6.2.0-20b4f0dfd078828bfb8e7fdd5ba85221/include
tinyxml2_EX_LIB := tinyxml2

ALL_TOOLS      += tkonlinesw
tkonlinesw_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/tkonlinesw/4.2.0-1_gcc7-ee95d41b479e7090b9bdc81f11d8537e/include
...
triton-inference-client_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/triton-inference-client/2.11.0-c80efc9ac4c5ac54f3869b523d7f6021/include
triton-inference-client_EX_LIB := grpcclient
triton-inference-client_EX_USE := protobuf grpc cuda re2

ALL_TOOLS      += ucx
ucx_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/ucx/1.12.1-d98bae19cb8f1c8b51e88639033e457e/include
ucx_EX_LIB := ucp uct ucs ucm

ALL_TOOLS      += utm
utm_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/utm/utm_0.11.2-de0545016d130fba86b295ac38227fd2/include
utm_EX_LIB := tmeventsetup tmtable tmxsd tmgrammar tmutil
utm_EX_USE := root_cxxdefaults

ALL_TOOLS      += valgrind
valgrind_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/valgrind/3.17.0-7ca83817e7379e83453f913e11e14834/include
...
vdt_headers_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/cms/vdt/0.4.3-26bd784324b069f05218637042354cf4/include
...
vecgeom_interface_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/vecgeom/v1.1.17-07b69d717ed40abe6434c19ba70a9983/include /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/vecgeom/v1.1.17-07b69d717ed40abe6434c19ba70a9983/include/VecGeom
...
ALL_TOOLS      += xerces-c
xerces-c_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/xerces-c/3.1.3-96261f23c7d6fbfb7d59be544bd882f3/include
xerces-c_EX_LIB := xerces-c
xerces-c_EX_USE := root_cxxdefaults

ALL_TOOLS      += xgboost
xgboost_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/xgboost/1.6.2-e2fae94cab3f93f96bd60fb839a14344/include
xgboost_EX_LIB := xgboost

ALL_TOOLS      += xpmem
xpmem_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/xpmem/v2.6.3-20220308-c7ef3156e39fc015b98dfdf5c149683b/include
xpmem_EX_LIB := xpmem

ALL_TOOLS      += xrdcl-record

ALL_TOOLS      += xrootd
xrootd_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/xrootd/5.5.1-0f563ccc18e94a7e64a93dc184abaae9/include/xrootd /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/xrootd/5.5.1-0f563ccc18e94a7e64a93dc184abaae9/include/xrootd/private
xrootd_EX_LIB := XrdUtils XrdCl
xrootd_EX_USE := root_cxxdefaults scitokens-cpp

ALL_TOOLS      += xtensor
xtensor_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/xtensor/0.24.1-0d2ecea7a15c3b14a11b33698e6fd31e/include
xtensor_EX_USE := xtl

ALL_TOOLS      += xtl
xtl_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/xtl/0.7.4-0ee309aa2981e6a00873fef1c69cb29c/include

ALL_TOOLS      += xz
xz_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/xz/5.2.5-83d0a00b575efd1701e07bedf7977343/include
xz_EX_LIB := lzma
xz_EX_USE := root_cxxdefaults

ALL_TOOLS      += yoda
yoda_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/yoda/1.9.7-4151fd43e6befb0b6efa2ae8f7f2550b/include
yoda_EX_LIB := YODA
yoda_EX_USE := root_cxxdefaults

ALL_TOOLS      += zlib
zlib_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/zlib/1.2.11-3dfb2715f3608466b74431b80eb9d788/include
zlib_EX_LIB := z
zlib_EX_USE := root_cxxdefaults

ALL_TOOLS      += zstd
zstd_EX_INCLUDE := /cvmfs/cms.cern.ch/el8_amd64_gcc11/external/zstd/1.5.2-290d3b726e169356bcb00341a538fea2/include
zstd_EX_LIB := zstd
